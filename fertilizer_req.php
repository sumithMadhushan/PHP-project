		...
		<nav class="navbar navbar-inverse navbar-static-top" roll="navigation"> <!-- navigation bar -->
			<div class="container-fluid"> <!-- reserve area for css fluid-for moved to left corner -->
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="fertilizer_req.php"><font color="green">Enter Your fertilizer Request Here</font></a> <!-- for replace with image: <img src="path of the image file"> -->
				</div> 
				<!--</div>-->
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<form class="navbar-form navbar-left" id="req_form" action="fertilizer_req.php" method="post">
					...
					<br><br>
					<div class="form-group">
					    <label>Name of fertilizer:</label><br><input type="text" name="name" class="form-control" placeholder="eg- T 750"><br/><br>
					</div>
					<br>
					<div class="form-group">
						<label>Quantity in kg:</label><br><input type="text" id="textF" name="quantity" class="form-control" placeholder=" eg- 150kg"><br><br>
					</div>
					<br>
					<div class="form-group">
