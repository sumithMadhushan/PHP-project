...
<nav class="navbar navbar-inverse navbar-static-top" roll="navigation"> <!-- navigation bar -->
			<div class="container-fluid"> <!-- reserve area for css fluid-for moved to left corner -->
				...
				<!--	<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"> -->
					...
					<a class="navbar-brand" href=""><font color="green">Advance Payments</font></a> <!-- for replace with image: <img src="path of the image file"> -->
				</div> 
				<!--</div>-->
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<form class="navbar-form navbar-left" id="req_form" action="set_advance.php" method="post">
					...
					<div>
					<button type="submit" class="btn btn-success" name="submit">Pay advanced payment</button>
					</div>
				</form>
				</div>
			</div>
